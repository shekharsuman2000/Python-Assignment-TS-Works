...
Note: Python should be intalled in your computer and Make sure you are in the correct directory where the 'app.py' file is located before running the command. 
